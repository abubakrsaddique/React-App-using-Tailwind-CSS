    ...
    <nav className="absolute w-full">
      <div className="flex justify-between items-center w-full p-4">
        <div className="hidden lg:flex items-center ml-8 space-x-4">
          ...
          <button className="text-base font-medium px-2">About</button>
          <button className="text-base font-medium px-2">Listings</button>
          <button className="text-base font-medium px-2">Services</button>
          <button className="text-base font-medium px-2">Blogs</button>
        </div>

        <div className="lg:hidden ml-4 max-md:mt-[-40%] max-sm:mt-[-90%] ">
        ...
        <div className="flex justify-center items-center mt-[0px] mr-[13%] p-4 max-md:mt-[-40%] max-sm:mt-[-90%]">
          <img src={Rezila} className="max-w-[90%] " alt="Rezila" />
        </div>

        <div className="hidden lg:flex items-center mr-10 space-x-6">
          ...
          <button className="bg-[#3a0ca3] text-white rounded-full px-8 py-4 flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
            ...
            <span className="text-base ml-2">Add Listing</span>
          </button>
        </div>
      </div>

      {isOpen && (
        <div className="lg:hidden fixed top-28 left-0 right-0 bg-white z-50 flex flex-col items-center py-4">
          <button className="block w-full text-left py-2 px-4">Home</button>
          <button className="block w-full text-left py-2 px-4">About</button>
          <button className="block w-full text-left py-2 px-4">Listings</button>
          <button className="block w-full text-left py-2 px-4">Services</button>
          <button className="block w-full text-left py-2 px-4">Blogs</button>
          <div className="flex items-center space-x-2 mt-4 mr-[65%]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="22"
              height="22"
          ...
          <button className="bg-[#3a0ca3] text-white rounded-full px-8 py-4 flex items-center mt-4 mr-[60%] ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
